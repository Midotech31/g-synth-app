...
urlpatterns = [
    ...
    path("assembly/", ExtendedSequenceDesignView.as_view(), name="design-assembly"),
    ...
    path("hybridize/", HybridizationView.as_view(), name="design-hybridize"),
    ...
    path("clone/worksheet/", CloneWorksheetView.as_view(), name="design-clone-worksheet"),
